            ...
            <div class="row grid-block">
                <div class="col-sm-6 item">
                    <div class="info centered">
                        <img src="./imgs/grid-02.jpg" alt="Millas - Our Work - Imagen #2">
                        <strong>Growth and fulfillment</strong> come from<br>
                        abandoning old practices and<br>
                        <em>embracing new ones.</em>
                    </div>
                </div>
                <div class="col-sm-6 item">
                    <div class="info centered">
                ...
                <div class="col-sm-6 item">
                    <div class="info centered">
                        <img src="./imgs/grid-04.jpg" alt="Millas - Our Work - Imagen #4">
                        <strong>Innovation</strong> requires<br>
                        <em>collaboration.</em>
                    </div>
                </div>
                <div class="col-sm-6 item">
